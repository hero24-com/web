...
export const HOME_SERVICE_OPTIONS = [
  ...
  { value: 'cleaningHome', label: 'cleaningHome' },
  { value: 'cleaningMoving', label: 'cleaningMoving' },
  { value: 'cleaningOffice', label: 'cleaningOffice' },
  { value: 'cleaningRenovation', label: 'cleaningRenovation' },
  { value: 'cleaningWindow', label: 'cleaningWindow' },
  { value: 'delivery', label: 'delivery' },
  { value: 'domesticHelp', label: 'domesticHelp' },
  { value: 'electrician', label: 'electrician' },
  { value: 'electronicAppliance', label: 'electronicAppliance' },
  { value: 'installationServices', label: 'installationServices' },
  { value: 'homeAppliance', label: 'homeAppliance' },
  { value: 'movingLifting', label: 'movingLifting' },
  { value: 'movingService', label: 'movingService' },
  { value: 'plumber', label: 'plumber' },
  { value: 'propertyMaintenance', label: 'propertyMaintenance' },
  { value: 'refrigerationAppliance', label: 'refrigerationAppliance' },
  { value: 'renovation', label: 'renovation' },
  { value: 'yardModification', label: 'yardModification' },
  { value: 'yardWork', label: 'yardWork' },
  { value: 'openOrder', label: 'openOrder' },
];
...
export const _services = [...Array(22)].map((_, index) => {
  ...
  return {
    ...
    slugKey: `nav.links.${SERVICE_NAME_KEYS[index]}`,
