...
export const _smartHome = [
  {
    ...
    options: [
      ...
      {
        title: 'Pikatoimitukset palveluille ja materiaaleille',
        tootip: 'Pikatoimitukset palveluille ja materiaaleille',
        disabled: false,
      },
      {
        title: '24/7 asiakaspalvelu, oma priorisoitu asiakaspalvelu',
        tootip: '24/7 asiakaspalvelu, oma priorisoitu asiakaspalvelu',
        disabled: false,
      },
      {
        title:
      ...
      {
        title: 'Töillä 3 vuoden takuu Hero24 brändin alla',
        tootip: 'Töillä 3 vuoden takuu Hero24 brändin alla',
        disabled: false,
      },
      {
