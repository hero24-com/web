...
const _mockService = _services[8];
const caseStudies = _caseStudies.slice(0, 6);

export default function DomesticHelpView() {
  return (
    <>
      <Container sx={{ overflow: 'hidden' }}>
        ...
        <HomeServiceDetailsGallery images={_mockService.gallery9} />

        <Grid container columnSpacing={8} rowSpacing={5} direction="row-reverse">
          <Grid xs={12} md={5} lg={5}>
            <HomeServiceDetailsReserveForm formId="c1dd53b7-4161-4ffd-ba3e-dc029cb1a6e8" />
          </Grid>
          ...
          <Grid xs={12} md={7} lg={7}>
            ...
            <HomeServicePaymentLink paymentLinks={_mockService.stripePaymentLink9} />
