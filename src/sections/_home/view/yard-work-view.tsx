...
const _mockService = _services[20];
const caseStudies = _caseStudies.slice(0, 6);

export default function YardWorkView() {
  ...
  return (
    <>
      <Container sx={{ overflow: 'hidden' }}>
        ...
        <HomeServiceDetailsGallery images={_mockService.gallery21} />

        <Grid container columnSpacing={8} rowSpacing={5} direction="row-reverse">
          <Grid xs={12} md={5} lg={5}>
            <HomeServiceDetailsReserveForm
              formId="19193a83-d3af-499e-88d8-d52a7555679f"
              subject={t('services.subjects.yardWork')}
            />
          </Grid>
          ...
          <Grid xs={12} md={7} lg={7}>
            ...
            <HomeServicePaymentLink paymentLinks={_mockService.stripePaymentLink21} />
