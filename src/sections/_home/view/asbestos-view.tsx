...
const _mockService = _services[1];
const caseStudies = _caseStudies.slice(0, 6);

export default function AsbestosView() {
  return (
    <>
        ...
        <Grid container columnSpacing={8} rowSpacing={5} direction="row-reverse">
          <Grid xs={12} md={5} lg={5}>
            <HomeServiceDetailsReserveForm
              formId="d764892e-a01e-42d0-bc31-da834057e289"
              subject="Uusi tarjouspyyntö - Asbestikartoitus"
            />
          </Grid>
          ...
          <Grid xs={12} md={7} lg={7}>
            ...
            <HomeServicePaymentLink paymentLinks={_mockService.stripePaymentLink2} />
