...
const _mockService = _services[10];
const caseStudies = _caseStudies.slice(0, 6);

export default function ElectronicApplianceView() {
  ...
  return (
    <>
      <Container sx={{ overflow: 'hidden' }}>
        ...
        <HomeServiceDetailsGallery images={_mockService.gallery11} />

        <Grid container columnSpacing={8} rowSpacing={5} direction="row-reverse">
          <Grid xs={12} md={5} lg={5}>
            <HomeServiceDetailsReserveForm
              formId="e1dc3f5f-ce6f-4b46-9f0c-ff4461661828"
              subject={t('services.subjects.electronicAppliance')}
            />
          </Grid>
