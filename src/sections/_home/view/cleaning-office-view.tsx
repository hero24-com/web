...
const _mockService = _services[4];
const caseStudies = _caseStudies.slice(0, 6);

export default function CleaningOfficeView() {
  return (
    <>
      <Container sx={{ overflow: 'hidden' }}>
        ...
        <HomeServiceDetailsGallery images={_mockService.gallery5} />

        <Grid container columnSpacing={8} rowSpacing={5} direction="row-reverse">
          <Grid xs={12} md={5} lg={5}>
            <HomeServiceDetailsReserveForm formId="43e4809d-18e4-4027-8c46-9860081f0e57" />
          </Grid>
