...
const _mockService = _services[12];
const caseStudies = _caseStudies.slice(0, 6);

export default function HomeApplianceView() {
  return (
    <>
        ...
        <Grid container columnSpacing={8} rowSpacing={5} direction="row-reverse">
          <Grid xs={12} md={5} lg={5}>
            <HomeServiceDetailsReserveForm
              formId="97f479da-effb-40ad-a738-641172d738e4"
              subject="Uusi tarjouspyyntö - Kodinkonehuolto"
            />
          </Grid>
          ...
          <Grid xs={12} md={7} lg={7}>
            ...
            <HomeServicePaymentLink paymentLinks={_mockService.stripePaymentLink13} />
