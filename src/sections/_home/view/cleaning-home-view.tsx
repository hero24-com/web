...
const _mockService = _services[2];
const caseStudies = _caseStudies.slice(0, 6);

export default function CleaningHomeView() {
  ...
  return (
    <>
      <Container sx={{ overflow: 'hidden' }}>
        ...
        <HomeServiceDetailsGallery images={_mockService.gallery3} />

        <Grid container columnSpacing={8} rowSpacing={5} direction="row-reverse">
          <Grid xs={12} md={5} lg={5}>
            <HomeServiceDetailsReserveForm
              formId="f3232961-b9dd-4b1f-b839-358f25daae35"
              subject={t('services.subjects.cleaningHome')}
            />
          </Grid>
          ...
          <Grid xs={12} md={7} lg={7}>
            ...
            <HomeServicePaymentLink paymentLinks={_mockService.stripePaymentLink3} />
